<x-app-layout>
    <div class="container mx-auto p-6 bg-white rounded shadow-lg">
        <h1 class="text-2xl font-bold mb-6 text-center">🎟️ Mis Entradas Confirmadas</h1>

        @if($misEntradas->isEmpty())
            <p class="text-center text-gray-600">Aún no tienes entradas confirmadas.</p>
        @else
                    ...
                    <tbody>
                        @foreach($misEntradas as $entrada)
                            <tr>
                                ...
                                <td class="border px-4 py-2">{{ $entrada->funcion->fecha }}</td>
