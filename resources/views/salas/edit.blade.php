<x-app-layout>
    <div class="min-h-screen bg-[#220044] py-10 px-6 flex items-center justify-center">
        <div class="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-lg">
            ...
            <form action="{{ route('salas.update', $sala->id_sala) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="text" name="nombre" value="{{ old('nombre', $sala->nombre) }}"
                ...
                <div>
                    ...
                    <input type="number" name="capacidad" value="{{ old('capacidad', $sala->capacidad) }}"
                        class="border border-gray-300 rounded-lg px-4 py-3 w-full focus:ring-2 focus:ring-yellow-400 focus:border-yellow-500" required>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="numero_fila" value="{{ old('numero_fila', $sala->numero_fila) }}"
                        class="border border-gray-300 rounded-lg px-4 py-3 w-full focus:ring-2 focus:ring-yellow-400 focus:border-yellow-500" required>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="numero_columna" value="{{ old('numero_columna', $sala->numero_columna) }}"
                        class="border border-gray-300 rounded-lg px-4 py-3 w-full focus:ring-2 focus:ring-yellow-400 focus:border-yellow-500" required>
                </div>
